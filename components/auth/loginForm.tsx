...
import { loginSchema, LoginValues } from "@/schema/auth/LoginSchema";
        ...
        <div className={cn("flex flex-col gap-6", className)} {...props}>
            <Card className="rounded-3xl shadow-xl">
                <CardHeader className="text-center">
                    ...
                    <CardDescription>
                        Zaloguj się do serwisu poprzez swój login i hasło
                    </CardDescription>
                </CardHeader>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="flex items-center gap-2">
                                        ...
                                        <FormControl>
                                            <Checkbox
                                                className="w-5 h-5 rounded-md border-2  text-primary transition-all duration-200 mt-0!"
                                                checked={field.value}
